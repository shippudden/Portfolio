...
import wireframes from "../../assets/High fidelity wireframes.png";
import wireframes2 from "../../assets/High fidelity wireframes 2.png";
import onboardingScreens from "../../assets/Onboarding Screens.png";
import registrationScreens from "../../assets/Registration Screen.png";
import colorPalette from "../../assets/Color palette.png";
import typography from "../../assets/Typography.png";

export const toyCraftStudio = {
    title: "ToyCraft Studio",
        introduction: [
            {
                description: `In today’s digital age, creativity and personalization play a major role in user engagement. The Toycraft Studio project emerged as part of a design challenge hosted by Lighthall, where the objective was to conceptualize and deliver an app that empowers users to customize toys effortlessly.`
            },
            {
                description: `The app focuses on playful toy customization through a simple yet engaging feature—color customization. Toycraft Studio allows users to experiment with different color palettes, encouraging creativity while ensuring a user-friendly and visually appealing experience.`
            },
            {
                description: `As the UI Designer, I focused on creating a vibrant, intuitive interface that captures the app’s essence: fun, creativity, and simplicity. I developed high-fidelity designs for the key screens, showcasing a seamless user flow from onboarding to toy customization.`
            },
        ],
        coverImage: toycraftImage,

        overview: "Toycraft Studio is a mobile app concept designed to give users the freedom to customize their toys through a playful and intuitive interface. The app focuses on a single engaging feature—color customization—allowing users to experiment with different color palettes and bring their creative ideas to life.",
        ...
        goalAndMethods: [
            {
                ...
                description: `Based on the understanding that children and parents enjoy creative expression through playful and easy-to-use platforms, the design was focused on a simple color customization feature that would be accessible and fun.`
            },
            {
                title: `Design Principles:`,
                description: `The design was shaped by the principles of simplicity, intuitiveness, and visual engagement, ensuring that the app would be enjoyable for users of all ages.`
            },
            {
                title: `Industry Trends:`,
                description: ` The concept of toy customization is becoming more popular in the industry, with many brands offering similar interactive features. The focus on color customization was chosen based on the assumption that it would appeal to a wide audience and serve as a primary form of creative interaction.`
            },
        ],
        highFidelityImage: TargetAudience,

        designprocess: `Though the project was based on a challenge with a focus on high-fidelity design, the design decisions were made with careful consideration of the user experience and the goals of the app. In this section, I'll explain the user flow, information architecture, and the design decisions that were made to enhance the user experience.`,

        userFlow: `The user flow is the visual path a user takes through the app, from opening the app to customizing a toy. It ensures that the app is intuitive and easy to navigate. For Toycraft Studio, I aimed for a smooth, simple user journey that would allow users to start with an engaging experience and easily access customization features.`,

        userFlowDetails: [
            {
                title: `1. Splash Screen:`,
                description: `• The user is greeted with the brand's playful logo and a welcoming design to set the tone.`
            },
            {
                title: `2. Onboarding Screens:`,
                description: `• Users are introduced to the app's main features, particularly the color customization option. I kept these screens minimal, offering a quick introduction to avoid overwhelming users.`
            },
            {
                title: `3. Sign-Up Screen:`,
                description: `• Users are prompted to sign up or continue as guests. This ensures easy entry without creating friction for users who may just want to explore.`
            },
            {
                title: `4. Home Page:`,
                description: `• The home page is the central hub where users can browse toys and start customizing. A prominent Call-to-Action (CTA) encourages users to select a toy to begin the customization process.`
            },
            {
                title: `5. Product Details:`,
                description: `• After selecting a toy, users are presented with the customization options. The color-change tool is prominent and easy to use, allowing users to change the toy’s color with a click or tap.`
            },
            {
                title: `6. Product Customization:`,
                description: `• Users can personalize their favourite toys by selecting the colors they prefer. The interface provides a palette of colors, and users can see real-time changes as they apply different colors to the toy. This interactive feature ensures an engaging and creative experience for users of all ages.`
            },
            {
                title: `7. Share`,
                description: `• Users are able to share the toys they personalize with others. This feature encourages social sharing and engagement, extending the app’s reach and creating a community around toy customization.`
            }
        ],

        whyThisFlow: `I kept the flow simple to ensure that users, especially children, wouldn’t feel lost or frustrated. The onboarding process is quick and focuses on educating the user about the core feature — color customization — without unnecessary steps.`,

        designChoices: `The design choices for Toycraft Studio were guided by the app’s playful and creative nature. I focused on creating a vibrant, engaging interface that would appeal to users of all ages, especially children and parents. The key design choices included:`,
        ...
        onboardingScreensImg: onboardingScreens,
        registrationScreensImg: registrationScreens,
        wireframesImg: wireframes,
        wireframesImg2: wireframes2,
        ...
        colorPaletteImg: colorPalette,
        typographyImg: typography,
